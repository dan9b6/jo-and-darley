    ...
    <main>
      ...
      <Section>
        <Container>
          ...
          <p className="mb-5">
            Our website collects your IP address and passes this information to
            Google Analytics so that we can monitor how our website is being
            used. Google uses your IP address in order to provide us with
            general information about use of our website and also to enable it
            to personalise advertisements on its own advertising network. Google
            may share this information with other Google services. The data we
            receive from Google Analytics allows us to make improvements to our
            website.
          </p>
          <h4>How we use your personal information</h4>
          <p className="mb-5">
            We use the data collected by our website to monitor trends by using
            analytics tools produced by Google which enable us to monitor how
            our website is being used so that we can operate our business more
            effectively.
          </p>
          ...
          <p className="mb-5">
            We will not actively send your data outside the EU but Google may do
            this. Google subscribes to the EU-US Privacy Shield framework which
            means that it has agreed to work with the appropriate regulatory
            authorities to resolve any complaints regarding the transfer of
            personal data where these complaints cannot be resolved directly.
            Organisations subscribing to the EU-US Privacy Shield framework (eg.
            Gmail, Dropbox, Mailchimp) are considered to be permitted
            destinations for personal data by the EU.
          </p>
          ...
          <p className="mb-5">
            ...
            information, please let us know by sending an email to{" "}
            <a href="mailto: danbh7296@gmail.com">...@....com</a>. You may raise
            any concerns or obtain more information from the{" "}
          ...
          <p>
            ...
            <a href="mailto:danbh7296@gmail.com">...@....com</a> if you wish to
            make a request.
          </p>
          <p>
